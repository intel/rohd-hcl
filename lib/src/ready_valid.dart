...
/// Module implementing a ready-AND-valid protocol
class ReadyAndValidStage extends Module {
  /// External enable for data transfer
  Logic get transfer => output('transfer');

  /// True if bubblesquashing is performed (e.g., can accept a first data token
  /// before a ready)
  final bool bubbleSquashing;

  /// Create a module implementing ready-AND-valid
