...
//
// floating_point_simple_dual_test.dart
// Tests of FloatingPointAdderSimpleDualDual -- non-rounding FP adder w/ dual path
//
// 2024 April 1
// Authors:
...
''');
    ...
    test('FP: simple adder singleton pipelined path', () async {
      ...
      final adder = FloatingPointAdderSimpleDual(clk: clk, fp1, fp2);
      await adder.build();
