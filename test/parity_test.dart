...
void main() {
  ...
  test('parity receiver checking', () async {
    ...
    expect(parityReceiver.originalData.value, LogicValue.ofString('00000000'));
    expect(parityReceiver.code.value, LogicValue.ofString('0'));
    expect(parityReceiver.error.value, LogicValue.ofString('0'));

    vector.put(bin('011111111'));
    expect(parityReceiver.originalData.value, LogicValue.ofString('11111111'));
    expect(parityReceiver.code.value, LogicValue.ofString('0'));
    expect(parityReceiver.error.value, LogicValue.ofString('0'));

    vector.put(bin('111111101'));
    expect(parityReceiver.originalData.value, LogicValue.ofString('11111101'));
    expect(parityReceiver.code.value, LogicValue.ofString('1'));
    expect(parityReceiver.error.value, LogicValue.ofString('0'));

    vector.put(bin('111110101'));
    expect(parityReceiver.originalData.value, LogicValue.ofString('11110101'));
    ...
    expect(parityReceiver.error.value, LogicValue.ofString('1'));
  });
}
