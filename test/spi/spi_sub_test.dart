...
void main() {
  ...
  Future<void> runTest(SpiSubTest spiSubTest, {bool dumpWaves = true}) async {
    Simulator.setMaxSimTime(6000);
    final sub = SpiSub(intf: spiSubTest.intf);
  ...
  test('simple transfers', () async {
    await runTest(SpiSubTest('simple'));
  });
}
